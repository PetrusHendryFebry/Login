...
public class ViewMahasiswa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_mahasiswa);
    ...
    private void loadRecyclerView() {
        ...
        ahc.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody)
            {
                ...
                RecyclerView.LayoutManager lm = new LinearLayoutManager(ViewMahasiswa.this);
                _recyclerView1.setLayoutManager(lm);

                MahasiswaAdapter ma = new MahasiswaAdapter(ViewMahasiswa.this, mahasiswaModelList);
